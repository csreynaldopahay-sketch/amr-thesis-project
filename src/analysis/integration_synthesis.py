...
def run_integration_synthesis(
    ...
    print("=" * 70)
    print("   ✅ Integration framework defined (Phase 2/3/4 outputs)")
    print("   ✅ Cluster–supervised alignment table generated")
    print("   ✅ Resistance archetype definition included")
    print("   ✅ Archetype summary table created")
    print("   ✅ Species–environment–resistance triangulation table")
    print("   ✅ MDR-enriched synthesis table")
    print("   ✅ Explicit negative findings documented")
    print("   ✅ Claim boundary statement included")
    print("   ✅ Integrative narrative structure")
